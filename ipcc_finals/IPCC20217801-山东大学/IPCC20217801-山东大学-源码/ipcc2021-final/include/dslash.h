...
void DslashEO_origin(lattice_fermion &src, lattice_fermion &dest, lattice_gauge &U, const bool dag);
void DslashOE_origin(lattice_fermion &src, lattice_fermion &dest, lattice_gauge &U, const bool dag);
